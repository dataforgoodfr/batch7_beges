...
class TeamMember:
    ...
    def get_card(self):
        ...
        if self.linkedin_link:
            links.append(
                dbc.CardLink(html.I(className="fab fa-linkedin fa-2x"), external_link=True, href=self.linkedin_link)
            )
        if self.github_link:
            links.append(
                dbc.CardLink(html.I(className="fab fa-github fa-2x"), external_link=True, href=self.github_link)
            )
        if self.email:
            links.append(
                dbc.CardLink(html.I(className="fa fa-envelope fa-2x"), external_link=True, href="mailto:" + self.email)
            )
...
team_members["artus"] = TeamMember(
    full_name="Artus Vuatrin",
    title="Data scientist",
    github_link="https://github.com/ArtusVuatrin",
    linkedin_link="https://www.linkedin.com/in/artus-vuatrin-577706124",
    image_url="https://media-exp1.licdn.com/dms/image/C5103AQFL2vwfNkhHAw/profile-displayphoto-shrink_200_200/0?e=1596672000&v=beta&t=_1BaokPcTgQ16zlrLUWgyXUnf8SEr7OwhPp641QQLJA",
)
team_members["ayoub"] = TeamMember(
    full_name="Ayoub Samaki",
    title="Data scientist",
    linkedin_link="https://www.linkedin.com/in/ayoub-samaki-0a158588/",
    github_link="https://github.com/Tiyop",
    image_url="https://media-exp1.licdn.com/dms/image/C5603AQH0Y9Ts4l7odg/profile-displayphoto-shrink_200_200/0?e=1596672000&v=beta&t=U09iFCsbpYH25kY7WR77cWiLRDdt55zuBgW_bZl-ahs",
)
team_members["tallulah"] = TeamMember(
    full_name="Tallulah Axinn",
    title="Data scientist",
    github_link="https://github.com/tallulaha",
    linkedin_link="https://www.linkedin.com/in/tallulah-axinn-586509a8",
)
team_members["gustave"] = TeamMember(
    full_name="Gustave Ronteix",
    title="Data scientist",
    github_link="https://github.com/gronteix",
    linkedin_link="https://www.linkedin.com/in/gustave-ronteix-677a82ba",
    image_url="https://media-exp1.licdn.com/dms/image/C5603AQFiE0RWAQ0KzQ/profile-displayphoto-shrink_200_200/0?e=1596672000&v=beta&t=PhG6TzTxW6xvqDLfX_lRZH_iL_Sp5CUNZuQHcdHPKNo",
)
...
layout = dbc.Row(
    dbc.Col(
        [
            ...
            dbc.Row(
                [
                    dbc.Col(team_members["anthony"].get_card(), width={"offset": 2, "size": 4},),
                    dbc.Col(team_members["maxime"].get_card(), width=4),
                ]
            ),
            html.Br(),
            ...
            dbc.Row(
                [
                    dbc.Col(team_members["antoine"].get_card(), width=4,),
                    dbc.Col(team_members["ayoub"].get_card(), width=4,),
                    dbc.Col(team_members["tallulah"].get_card(), width=4,),
                ]
            ),
            dbc.Row(
                [
                    dbc.Col(team_members["gustave"].get_card(), width=4,),
                    dbc.Col(team_members["artus"].get_card(), width=4,),
                    dbc.Col(team_members["maria"].get_card(), width=4,),
                ]
            ),
            dbc.Row([dbc.Col(team_members["svetlana"].get_card(), width=4,),]),
        ],
